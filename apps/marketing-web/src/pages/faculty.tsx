...
export default function Faculty() {
  ...
  return (
    <>
      <Helmet>
        <title>Experienced Teachers at Toppers Coaching Center Karachi</title>
        <meta name="description" content="Meet our qualified faculty at Toppers Coaching Center in Karachi. Experienced teachers dedicated to student success and academic excellence." />
        <link rel="canonical" href="https://topperscoachingcenter.com/faculty" />
        <meta property="og:title" content="Experienced Teachers at Toppers Coaching Center Karachi" />
        <meta property="og:description" content="Meet our qualified faculty at Toppers Coaching Center in Karachi. Experienced teachers dedicated to student success." />
        <meta property="og:url" content="https://topperscoachingcenter.com/faculty" />
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="mt-4 text-slate-600">
            ...
            to see how each faculty member supports every stage from Montessori to Matric.
          </p>
        </div>
