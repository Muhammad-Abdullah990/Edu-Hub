...
import { BookOpen, GraduationCap, Star, Pencil, Trophy, Users, Target, ShieldCheck, ArrowRight, TrendingUp } from "lucide-react";

export default function Home() {
  return (
    <>
      <Helmet>
        <title>Best Coaching Center in Karachi | Toppers Coaching Center</title>
        <meta name="description" content="19 years of excellence in education. Trusted coaching center in Karachi helping students achieve top results. Join our proven coaching classes in Baldia Town." />
        <link rel="canonical" href="https://topperscoachingcenter.com/" />
        <meta property="og:title" content="Best Coaching Center in Karachi | Toppers Coaching Center" />
        <meta property="og:description" content="19 years of excellence in education. Trusted coaching center in Karachi helping students achieve top results." />
        <meta property="og:url" content="https://topperscoachingcenter.com/" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Best Coaching Center in Karachi | Toppers Coaching Center" />
        <meta name="twitter:description" content="19 years of excellence in education. Trusted coaching center in Karachi helping students achieve top results." />
      </Helmet>
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden bg-radial-light">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
          <img
            src="./home-watermark.webp"
            alt="Toppers Coaching Center Baldia Karachi emblem watermark"
            loading="eager"
            decoding="async"
            fetchPriority="high"
            width="500"
            height="500"
            className="w-full max-w-4xl opacity-5 md:opacity-10 object-contain"
          />
        </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <span className="inline-block py-1 px-3 rounded-full bg-white/50 border border-primary/10 text-primary text-sm font-semibold tracking-wider mb-6">
                🎓 19+ Years of Excellence • Established 2006
              </span>
            </motion.div>
            ...
            >
              ...
              <br />
              <span className="text-[#1E3A8A] bg-gradient-to-r from-primary to-blue-700 bg-clip-text text-transparent">Building Success Since 2006</span>
            </motion.h1>
            ...
            >
              We Don't Teach — We Build TOPPERS 🚀<br/>
              <span className="text-sm text-slate-500">97%+ Success Rate • Limited Enrollment • Family-Run Since Day One</span>
            </motion.p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { label: "Years of Excellence", value: "19+", icon: Trophy },
              { label: "Current Success Rate", value: "97%", icon: TrendingUp },
              { label: "Dedicated Faculty", value: "100%", icon: Users },
              { label: "Target Success", value: "98%", icon: Star },
            ].map((stat, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
      ...
      {/* BEFORE & AFTER RESULTS - NEW SECTION */}
      <section className="py-24 bg-gradient-to-b from-blue-50 to-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">Real improvements from actual students. Watch how our personalized coaching transforms marks and confidence.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            >
              <h3 className="text-xl font-bold text-slate-900 mb-6">Mathematics Improvement</h3>
              <div className="space-y-4 mb-6">
                <div>
                  <p className="text-sm font-semibold text-slate-600 mb-2">Before Toppers</p>
                  <div className="flex items-end gap-3">
                    <div className="text-3xl font-bold text-red-600">45%</div>
                    <p className="text-sm text-slate-500">Struggled with basics</p>
                  </div>
                </div>
                <div className="text-center text-2xl text-slate-400">↓</div>
                <div>
                  <p className="text-sm font-semibold text-slate-600 mb-2">After 6 Months</p>
                  <div className="flex items-end gap-3">
                    <div className="text-3xl font-bold text-green-600">92%</div>
                    <p className="text-sm text-slate-500">Board exam topper</p>
                  </div>
                </div>
              </div>
              <div className="bg-green-50 px-4 py-3 rounded-xl border border-green-200">
                <p className="text-sm font-semibold text-green-700">+47 points improvement ✓</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100 hover:shadow-xl transition-all"
            >
              <h3 className="text-xl font-bold text-slate-900 mb-6">Science Subjects</h3>
              <div className="space-y-4 mb-6">
                <div>
                  <p className="text-sm font-semibold text-slate-600 mb-2">Before Toppers</p>
                  <div className="flex items-end gap-3">
                    <div className="text-3xl font-bold text-red-600">52%</div>
                    <p className="text-sm text-slate-500">Concepts unclear</p>
                  </div>
                </div>
                <div className="text-center text-2xl text-slate-400">↓</div>
                <div>
                  <p className="text-sm font-semibold text-slate-600 mb-2">After 8 Months</p>
                  <div className="flex items-end gap-3">
                    <div className="text-3xl font-bold text-green-600">88%</div>
                    <p className="text-sm text-slate-500">Strong conceptual base</p>
                  </div>
                </div>
              </div>
              <div className="bg-green-50 px-4 py-3 rounded-xl border border-green-200">
                <p className="text-sm font-semibold text-green-700">+36 points improvement ✓</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100 hover:shadow-xl transition-all"
            >
              <h3 className="text-xl font-bold text-slate-900 mb-6">English Language</h3>
              <div className="space-y-4 mb-6">
                <div>
                  <p className="text-sm font-semibold text-slate-600 mb-2">Before Toppers</p>
                  <div className="flex items-end gap-3">
                    <div className="text-3xl font-bold text-red-600">58%</div>
                    <p className="text-sm text-slate-500">Grammar & basics weak</p>
                  </div>
                </div>
                <div className="text-center text-2xl text-slate-400">↓</div>
                <div>
                  ...
                  <div className="flex items-end gap-3">
                    ...
                    <p className="text-sm text-slate-500">Fluent communicator</p>
                  </div>
                </div>
              </div>
              <div className="bg-green-50 px-4 py-3 rounded-xl border border-green-200">
                <p className="text-sm font-semibold text-green-700">+32 points improvement ✓</p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="text-center mt-12">
            <Link href="/results">
              <WaveWrap variant="blue" rounded="rounded-full">
                <Button className="text-lg h-12 px-8 bg-primary hover:bg-primary/90 text-white rounded-full">
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Parents & Students Trust Us</h2>
            <p className="text-slate-600 text-lg">Real testimonials from families who saw their children transform their academic journey.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-slate-600 mb-6 italic">"Toppers didn't just teach; they guided my future. The mentorship beyond exams was crucial for my medical aspirations."</p>
              <Link href="/student-success" className="group inline-flex items-center gap-1 text-primary font-medium px-3 py-1.5 rounded-lg transition-all duration-300 hover:shadow-[0_0_14px_rgba(30,58,138,0.25)] hover:bg-primary/5">
                Read Full Story
                <motion.span
                  animate={{ x: [0, 5, 0] }}
      ...
      <section className="py-24 bg-primary relative overflow-hidden text-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Ready to Transform Your Child's Future?</h2>
          <p className="text-primary-foreground/80 text-xl max-w-2xl mx-auto mb-10">
            Join hundreds of successful students. Limited seats available this semester.
          </p>
          <Link href="/contact">
